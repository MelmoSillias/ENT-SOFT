...
export const appConfig = {
  app: {
    ...
    name: 'ENT-SOFT',
    title: 'ENT-SOFT',
    subtitle: 'Application métier — ENT',
    description: 'Application métier pour ENT — gestion de projets d\'installation télécom et solaire.',
  },
  branding: {
    name: 'ENT-SOFT',
    shortName: 'ENT',
    tagline: 'Installations télécom & solaire',
